 ...
 */
public class AdapterSearchRestaurant extends RecyclerView.Adapter<AdapterSearchRestaurant.ViewHolder>{

    List<RestaurantRequest> restaurants;
    Context context;

    public AdapterSearchRestaurant(List<RestaurantRequest> restaurants) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final RestaurantRequest restaurant = restaurants.get(position);

        System.out.println("Nama dagangan "+restaurant.getNama_lengkap());
        holder.Name.setText(restaurant.getNama_lengkap());
        Picasso.with(context).load("http://morefoods.hol.es/img/"+restaurant.getPicture_backgournd()).into(holder.img_background);
        Picasso.with(context).load("http://morefoods.hol.es/img/"+restaurant.getPicture_profile()).into(holder.pic_profile);
        ...
        holder.btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("namasatu",  restaurant.getNama_lengkap());
                i.putExtra("pic_dpsatu", restaurant.getPicture_profile());
                i.putExtra("pic_bgsatu", restaurant.getPicture_backgournd());
        ...
        holder.btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("id_user", restaurant.getId_user());
                i.putExtra("nama",  restaurant.getNama_lengkap());
                i.putExtra("pic_dp", restaurant.getPicture_profile());
                i.putExtra("pic_bg", restaurant.getPicture_backgournd());
                i.putExtra("status", "1");
